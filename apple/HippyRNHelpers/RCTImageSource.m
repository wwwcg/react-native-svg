...
@implementation HippyConvert (ImageSource)
...
+ (RCTImageSource *)RCTImageSource:(id)json
{
  ...
  if ([json isKindOfClass:[NSDictionary class]]) {
    ...
    HippyLogConvertError(json, @"an image. Did you forget to call resolveAssetSource() on the JS side?");
    return nil;
  }
...
Hippy_ARRAY_CONVERTER(RCTImageSource)
