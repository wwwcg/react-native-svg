...
HIPPY_EXPORT_VIEW_PROPERTY(fill, RNSVGBrush)
HIPPY_EXPORT_VIEW_PROPERTY(fillOpacity, CGFloat)
HIPPY_EXPORT_VIEW_PROPERTY(fillRule, RNSVGCGFCRule)
HIPPY_EXPORT_VIEW_PROPERTY(stroke, RNSVGBrush)
HIPPY_EXPORT_VIEW_PROPERTY(strokeOpacity, CGFloat)
HIPPY_EXPORT_VIEW_PROPERTY(strokeWidth, RNSVGLength*)
HIPPY_EXPORT_VIEW_PROPERTY(strokeLinecap, CGLineCap)
HIPPY_EXPORT_VIEW_PROPERTY(strokeLinejoin, CGLineJoin)
HIPPY_EXPORT_VIEW_PROPERTY(strokeDasharray, NSArray<RNSVGLength *>)
HIPPY_EXPORT_VIEW_PROPERTY(strokeDashoffset, CGFloat)
HIPPY_EXPORT_VIEW_PROPERTY(strokeMiterlimit, CGFloat)
HIPPY_EXPORT_VIEW_PROPERTY(vectorEffect, int)
HIPPY_EXPORT_VIEW_PROPERTY(propList, NSArray<NSString *>)

//HIPPY_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(isPointInFill:(nonnull NSNumber *)reactTag options:(NSDictionary *)options)
//{
...
//        HippyLogError(@"Invalid svg returned from registry, expecting RNSVGRenderable, got: %@", view);
//        return [NSNumber numberWithBool:false];
//    }
//    if (options == nil) {
//        HippyLogError(@"Invalid options given to isPointInFill, got: %@", options);
//        return [NSNumber numberWithBool:false];
//    }
...
//        HippyLogError(@"Invalid x or y given to isPointInFill");
//        return [NSNumber numberWithBool:false];
//    }
...
//}
//
//HIPPY_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(isPointInStroke:(nonnull NSNumber *)reactTag options:(NSDictionary *)options)
//{
//    __block RNSVGPlatformView *view;
//    dispatch_sync(dispatch_get_main_queue(), ^{
//        view = [self.bridge.uiManager viewForReactTag:reactTag];
...
//}
//
//HIPPY_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getTotalLength:(nonnull NSNumber *)reactTag)
//{
//    __block RNSVGPlatformView *view;
//    dispatch_sync(dispatch_get_main_queue(), ^{
//        view = [self.bridge.uiManager viewForReactTag:reactTag];
...
//}
//
//HIPPY_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getPointAtLength:(nonnull NSNumber *)reactTag options:(NSDictionary *)options)
//{
//    __block RNSVGPlatformView *view;
//    dispatch_sync(dispatch_get_main_queue(), ^{
//        view = [self.bridge.uiManager viewForReactTag:reactTag];
...
//}
//
//HIPPY_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getBBox:(nonnull NSNumber *)reactTag options:(NSDictionary *)options)
//{
//    __block RNSVGPlatformView *view;
//    dispatch_sync(dispatch_get_main_queue(), ^{
//        view = [self.bridge.uiManager viewForReactTag:reactTag];
...
//}
//
//HIPPY_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getCTM:(nonnull NSNumber *)reactTag)
//{
//    __block RNSVGPlatformView *view;
//    dispatch_sync(dispatch_get_main_queue(), ^{
//        view = [self.bridge.uiManager viewForReactTag:reactTag];
...
//}
//
//HIPPY_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getScreenCTM:(nonnull NSNumber *)reactTag)
//{
//    __block RNSVGPlatformView *view;
//    dispatch_sync(dispatch_get_main_queue(), ^{
//        view = [self.bridge.uiManager viewForReactTag:reactTag];
